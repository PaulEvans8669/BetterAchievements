...
public class Events implements Listener{
	...
	public void onPlayerAchievementAwarded(PlayerAchievementAwardedEvent AwEv){
		...
		AwEv.getPlayer().addPotionEffect(new PotionEffect(PotionEffectType.getByName(plugin.getConfig().getString("Firstpot.effect")),plugin.getConfig().getInt("Firstpot.time"),plugin.getConfig().getInt("Firstpoot.level")));
		AwEv.getPlayer().addPotionEffect(new PotionEffect(PotionEffectType.getByName(plugin.getConfig().getString("Secondpot.effect")),plugin.getConfig().getInt("Secondpot.time"),plugin.getConfig().getInt("Secondpoot.level")));
